<x-layout-web>
    ...
    <div class="bg-image hv-100 d-flex align-items-center"
        style="background-image: url({{ asset('img/fondos/fondo.png') }})">
        <div class="h-auto">
            <a class="ml-10p" href="{{ route('web.inicio') }}">
                <svg width="70" height="53" viewBox="0 0 106 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M106 26.5L2.99999 26.5M2.99999 26.5L32.2089 51M2.99999 26.5L32.209 2" stroke="#E84343"
                        stroke-width="3" />
                </svg>
            </a>

            <div class="cuadro-blanco d-flex align-items-center justify-content-center">
                <div class="h-auto">
                    <h1 class="text-center fw-400 texto-lg-4r">Contacto
                    </h1>
                        ...
                        <p>
                            <svg width="30" height="30" viewBox="0 0 40 40" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#16253E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            56-27-45-71-10
                        </p>
                    </a><br /> --}}
