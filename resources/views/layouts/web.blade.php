...
<head>
    ...
    <link href="{{ asset('css/style.css?ver=1.0.12') }}" rel="stylesheet" media="screen">
    <link href="{{ asset('css/colors.css?ver=1.0.12') }}" rel="stylesheet" media="screen">
    <link href="{{ asset('css/style2.css?ver=1.0.12') }}" rel="stylesheet" media="screen">
    <link href="{{ asset('css/utilidades.css?ver=1.0.12') }}" rel="stylesheet" media="screen">
    <link href="{{ asset('css/base.css?ver=1.0.12') }}" rel="stylesheet" media="screen">
...
<body>
    ...
    <script src="{{ asset('js/datepicker.js?ver=1.0.12') }}"></script>
    <script src="{{ asset('js/form.js?ver=1.0.12') }}"></script>
