                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td style="padding:0;Margin:0;padding-top:25px;background-color:#ffffff"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        class="adapt-img"
                                                                        src="https://tcxclc.stripocdn.email/content/guids/CABINET_7dc9661741b062d9a5cbee909178eca7/images/group_22.png"
                                                                        alt
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="center"
                                                                    ...
                                                                    <h1
                                                                        style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;font-size:30px;font-style:normal;font-weight:normal;color:#16253e">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <table width="100%" height="100%" cellspacing="0"
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                style="padding:0;Margin:0;border-bottom:1px solid #dadada;background:#FFFFFF none repeat scroll 0% 0%;height:1px;width:100%;margin:0px">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left"
                                            style="Margin:0;padding-bottom:10px;padding-top:30px;padding-left:30px;padding-right:30px">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center"
                                                                    ...
                                                                    <td align="left" style="padding:0;Margin:0">
                                                                        <ul>
                                                                            @foreach ($years as $item)
                                                                                <li
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:22px;Margin-bottom:15px;color:#999999;font-size:18px">
                                                                                    Edad: {{ $item->edad }}</li>
                                                                            @endforeach
                                                                        </ul>
                                                                    </td>
