        ...
        <div class="row mt-3 d-none form-2">
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field-2">
                    ...
                    <select id="ida_y_vuelta2" onchange="tipoViaje2()" wire:model.defer="createForm2.ida_y_vuelta">
                        <option class="text-center" value="1">Ida y vuelta</option>
                        <option class="text-center" value="2">Solo ida</option>
                    </select>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field autoComplete_wrapper">
                    ...
                    <input type="text" id="origen2" placeholder="Ciudad de origen" autocomplete="off"
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field">
                    ...
                    <input type="text" id="destino2" placeholder="Ciudad de destino" maxlength="255"
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field input-fecha-inicio2">
                    <svg width="20" height="22" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M21.7498 4.83337H7.24984C4.58046 4.83337 2.4165 6.99733 2.4165 9.66671V21.75C2.4165 24.4194 4.58046 26.5834 7.24984 26.5834H21.7498C24.4192 26.5834 26.5832 24.4194 26.5832 21.75V9.66671C26.5832 6.99733 24.4192 4.83337 21.7498 4.83337Z"
                            stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field input-fecha-fin2">
                    <svg width="20" height="22" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M21.7498 4.83337H7.24984C4.58046 4.83337 2.4165 6.99733 2.4165 9.66671V21.75C2.4165 24.4194 4.58046 26.5834 7.24984 26.5834H21.7498C24.4192 26.5834 26.5832 24.4194 26.5832 21.75V9.66671C26.5832 6.99733 24.4192 4.83337 21.7498 4.83337Z"
                            stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <div class="row mt-3 d-none form-3">
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field-2">
                    ...
                    <select id="ida_y_vuelta3" onchange="tipoViaje3()" wire:model.defer="createForm3.ida_y_vuelta">
                        <option class="text-center" value="1">Ida y vuelta</option>
                        <option class="text-center" value="2">Solo ida</option>
                    </select>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field autoComplete_wrapper">
                    ...
                    <input type="text" id="origen3" placeholder="Ciudad de origen" autocomplete="off"
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field">
                    ...
                    <input type="text" id="destino3" placeholder="Ciudad de destino" maxlength="255"
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field input-fecha-fin3">
                    <svg width="20" height="22" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M21.7498 4.83337H7.24984C4.58046 4.83337 2.4165 6.99733 2.4165 9.66671V21.75C2.4165 24.4194 4.58046 26.5834 7.24984 26.5834H21.7498C24.4192 26.5834 26.5832 24.4194 26.5832 21.75V9.66671C26.5832 6.99733 24.4192 4.83337 21.7498 4.83337Z"
                            stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
