<div x-data>
    <form onsubmit="return registrarForm(event)">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-6 ocultar-pc">
                <div class="input-field-2">
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field autoComplete_wrapper">
                    ...
                    <input type="text" id="origen" placeholder="Ciudad de origen" autocomplete="off"
            ...
            <div class="col-lg-4 col-md-4 col-6">
                <div class="input-field">
                    ...
                    <input type="text" id="destino" placeholder="Ciudad de destino" maxlength="255"
            ...
            <div class="col-lg-4 col-md-4 col-6 ocultar-md">
                <div class="input-field-2">
                    <svg width="20" height="18" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0)">
                            <path
